            ...
            <div class=" w-50 h-100 d-flex justify-content-center align-content-center align-items-center">
                <div class="container px-5 py-5 rounded-3 shadow" style="">
                    <div class="form" >
                        ...
                        <form class="mt-4" action="/logincheck" method="post">
                            @csrf
                            <div class="mb-3">
                        ...
                        <div class="mt-1 d-flex  justify-content-center">
                            <p>you can join as admin</p>
                            <a href="/adminlogin" class="text-decoration-underline">join as admin</a>
                        </div>
            ...
            <div class="form_input">
                <form action="/logincheck" method="post">
                    ...
                    <div class="regestor"> 
                        ...
                        <p>Don't have account <a href="/regester">Registor</a></p>
                    </div>
                    <div class="butt d-flex justify-content-evenly" style="height: 40px">
